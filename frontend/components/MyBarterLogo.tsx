...
const MyBarterLogo = ({ className = "h-8" }) => {
  return (
    <div className={`flex-shrink-0 ${className}`} style={{ aspectRatio: '1 / 1' }}>
      <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%', objectFit: 'contain' }}>
